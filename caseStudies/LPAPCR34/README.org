    ...
    , when = Just
        ( Any
            [ Compound
                ( Any
                    [ Cons
                        ( "detracts" :@ [ ( "en" , "detracts" ) ]
                        ) ( "from" :@ [] )
                    , Cons
                        ( "incompat" :@ [ ( "en" , "is incompatible" ) ]
                        ) ( "with" :@ [] )
                    , Cons
                        ( "derogates" :@ [ ( "en" , "derogates" ) ]
                        ) ( "from" :@ [] )
                    ]
                )
                [ TKey "Business"
            ...
            , Compound
                ...
                , Any
                    [ BinOp
                        ( BinOp ( TKey "LP" ) ( "'s" :@ [] )
                            ( "occ" :@ [ ( "en" , "primary occupation" ) ] )
                        ) ( "of" :@ [] )
                        ( BinOp
                            ( "practising" :@ [ ( "en" , "practising" ) ]
                            ) ( "as" :@ [] )
                            ( "lawyer" :@
                                [
                                    ( "en"
            ...
            , Compound
                ...
                , Cons
                    ...
                    ( BinOp
                        ( Any
                            [ "unauthorised person" :@ [ ( "en" , "unauthorised person" ) ]
                            ]
                        ) ( "for" :@ [] )
                        ( BinOp
