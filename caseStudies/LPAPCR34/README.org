...
#+begin_example
[ Section
    ( "34" :@ [ ( "en" , "Thirty Four, part One" ) ] )
, DRule
    { rulename = "34.1" :@ [ ( "en" , "Prohibitions" ) ]
    , party = "LP" :@ [ ( "en" , "Legal Practitioner" ) ]
    , dmodal = DShant
    , action = Compound
        ( "accept" :@ [ ( "en" , "accept" ) ] )
        [ "execA" :@ [ ( "en" , "executive appointment" ) ]
    ...
    , when = Just
        ( Any
            [ Compound
                ( Any
                    [ Cons
                        ( "detracts" :@ [ ( "en" , "detracts" ) ] ) ( "from" :@ [] )
                    , Cons
                        ( "incompat" :@ [ ( "en" , "is incompatible" ) ] ) ( "with" :@ [] )
                    , Cons
                        ( "derogates" :@ [ ( "en" , "derogates" ) ] ) ( "from" :@ [] )
                    ]
                )
                [ TKey "Business"
                , BinOp
                    ( "dignity" :@ [ ( "en" , "dignity" ) ] ) ( "of" :@ [] )
                    ( "prof" :@ [ ( "en" , "legal profession" ) ]
                    )
                ]
            , Compound
                ( "materially interferes with" :@ [ ( "en" , "materially interferes with" ) ] )
                [ TKey "Business"
                , Any
                    [ BinOp
                        ( BinOp ( TKey "LP" ) ( "'s" :@ [] ) ( "occ" :@ [ ( "en" , "primary occupation" ) ] ) ) ( "of" :@ [] )
                        ( BinOp
                            ( "practising" :@ [ ( "en" , "practising" ) ] ) ( "as" :@ [] )
                            ( "lawyer" :@ [ ( "en" , "lawyer" ) ]
                            )
                        )
                    , BinOp ( TKey "LP" ) ( "'s" :@ [] )
                    ...
                    , BinOp
                        ( "representation" :@ [ ( "en" , "representation" ) ] ) ( "of" :@ [] )
                        ( BinOp ( TKey "LP" ) ( "'s" :@ [] )
                            ( "clients" :@ [ ( "en" , "clients" ) ]
                            )
                        )
            ...
            , Compound
                ( "is likely to" :@ [ ( "en" , "is likely to" ) ] )
                [ TKey "Business"
                , BinOp
                    ( "unfairly attract business" :@ [ ( "en" , "unfairly attract business" ) ] )
                    ( "in" :@ [] )
                    ( "practice of law" :@ [ ( "en" , "practice of law" ) ]
                    )
                ]
            , Compound
                ( "involves" :@ [ ( "en" , "involves" ) ]
                )
                [ TKey "Business"
                , Cons
                    ( Any
                    ...
                    ( BinOp
                        ( Any [ "unauthorised person" :@ [ ( "en" , "unauthorised person" ) ] ] )
                        ( "for" :@ [] )
                        ( BinOp
                            ( "legal work performed" :@ [ ( "en" , "legal work performed" ) ] )
                            ( "by" :@ [] )
                            ( TKey "LP" )
                        )
                    )
            ...
            , Compound
                ( "isIn" :@ [ ( "en" , "is in" ) ] )
                [ TKey "Business" , "Schedule1" :@ [ ( "en" , "First Schedule" ) ] ]
            , Compound
                ( "isProhibitedBy" :@ [ ( "en" , "is prohibited by" ) ] )
                [ TKey "Business"
                , Any
                    [ "Act" :@ [ ( "en" , "Act" ) ]
                    , Any
                        [ "these Rules" :@ [ ( "en" , "these Rules" ) ]
                        , "any other subsidiary legislation made under the Act" :@ [ ( "en" , "any other subsidiary legislation made under the Act" ) ]
                        ]
                    , Cons
                        ( And
                            [ "practice directions" :@ [ ( "en" , "practice directions" ) ]
                            , "guidance notes" :@ [ ( "en" , "guidance notes" ) ]
                            , "rulings" :@ [ ( "en" , "rulings" ) ]
                            ]
                            )
                            ( "issued under section 71(6) of the Act" :@ [ ( "en" , "issued under section 71(6) of the Act" ) ]
                        )
                    , Cons
                        ( And
                            [ "practice directions" :@ [ ( "en" , "practice directions" ) ]
                        ...
                        ( BinOp
                            ( "relating" :@ [ ( "en" , "relating" ) ] )
                            ( "to" :@ [] )
                            ( Cons
                                ( And
                                    [ "professional practice" :@ [ ( "en" , "professional practice" ) ]
                                    , "etiquette" :@ [ ( "en" , "etiquette" ) ]
                                    , "conduct" :@ [ ( "en" , "conduct" ) ]
...
**** The STDIN parser is on hold at the moment

#+begin_src haskell :noweb-ref 34-app-parse
  someFunc :: IO ()
  someFunc = do
    myinput <- getContents
...
**** Instead we will just print the manually generated AST
...
#+begin_src haskell :noweb-ref 34-prolog
  stmToProlog :: Stm -> String
  stmTorolog (Section te)       = unlines [ unwords [ "%% SECTION", teToProlog te ] ]
  stmTorolog (DRule rn p d a w) = unlines [ unwords [ "%%  D RULE", teToProlog rn ],
                                            unwords [ "%%   PARTY", teToProlog p ]
                                          ]
  -- rule_34_1(party(LegalPractitioner), shant, accept(ExecA)) :- assocWith(ExecA, Business),
  --    detracts_from


  -- teToProlog :: TermExpr -> String
  -- teToProlog 
