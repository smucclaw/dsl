...
GROUP UnregisteredSecurity :gf:"incantation"
  RULE 00
    ...
    DECLARE [ Contract & Contract.securitiesPursuant ] ARE Jurisdiction.unregisteredSecurity
    ...
    GIVEN Contract, Jurisdiction
      PARTY NOBODY
        MAY :gf:"passiveVoice" -- converts to "these securities may not be..."
            ...
            [ Contract U Contract.securitiesPursuant ] AS action
...
DEFINE investor ISA Person
DEFINE company  ISA CorporatePerson
