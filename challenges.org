...
| ([[https://hackage.haskell.org/package/base-4.20.0.1/docs/Prelude.html#v:all][all]] (> 0), [Ord a], False) | The result is true because at least one input was negative.             | ~[ x \vert x <- inputs, not $ f x ]~ |
