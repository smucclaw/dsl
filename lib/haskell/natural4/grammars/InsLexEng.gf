concrete InsLexEng of InsLex = NL4BaseEng **
  open ParadigmsEng, Prelude in {
    ...
    lin _travel_by_V2 = mkV2 (us_britishV "travel") (mkPrep "by") ;
    ...
    lin _start_V = us_britishV "start"  ;
    ...
    lin _occur_during_V2 = mkV2 (us_britishV "occur") (mkPrep "during") ;
    ...
    lin _riot_V = us_britishV "riot"  ;
    lin _transport_N = mkN "transport"  ;
    lin _H7N7_N = mkN "H7N7"  ;
    lin _both_Conj = mkConj "both"  ;
    lin _leg_N = mkN "leg"  ;
    ...
    lin _before_Conj = mkConj "before"  ;
    lin _p_N = mkN "p"  ;
    ...
    lin _during_Prep = mkPrep "during"  ;
    ...
    lin _before_Prep = mkPrep "before"  ;
    ...
    lin _hernia_V = us_britishV "hernia"  ;
