...
Failures:
  ...
  test/Spec.hs:124:3: 
  1) PDPA inline-1-r
       expected: [((["multiwonk"],Means,Any Nothing [Leaf (RPMT ["poopoo"]),Leaf (RPMT ["the","honk"]),Leaf (RPMT ["ponk"])]),[])]
        but got: [((["multiwonk"],Means,Any Nothing [Leaf (RPMT ["poopoo"]),Any (Just (Pre "the")) [Leaf (RPMT ["honk"]),Leaf (RPMT ["ponk"])]]),[])]

  To rerun use: --match "/PDPA/inline-1-r/"

Randomized with seed 1785435036
