...
***** withlabels indented first way -- doesn't work
:PROPERTIES:
...
***** withlabels indented second way -- doesn't work
:PROPERTIES:
...
***** withlabels indented third way -- doesn't work
:PROPERTIES:
...
***** withlabels indented fourth way -- doesn't work
:PROPERTIES:
...
***** withlabels indented sixth way -- doesn't work
:PROPERTIES:
...
maybe the parser is brittle here, it doesn't allow blank spaces? let's dive in and find out!
