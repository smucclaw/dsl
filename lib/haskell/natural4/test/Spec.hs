...
--    describe "Petri" $ do
      ...
      filetest "boolstructp-3" "groundrules, extended"
        (parseWith grExtend pRules) [ ["the person","is immortal"]
