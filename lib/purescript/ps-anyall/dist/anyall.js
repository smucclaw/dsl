          ...
          andOr: (function () {
              ...
              if (v.andOr instanceof Simply) {
                  return Option.fromRecord(Option.fromRecordAny(Option.fromRecordOptionConsMaybe(new Data_Symbol.IsSymbol(function () {
                      ...
                      nl: Foreign_Object.fromFoldable(Data_Foldable.foldableArray)(Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray)(v.tagNL))
                  });
              };
              throw new Error("Failed pattern match at AnyAll.Types (line 175, column 20 - line 179, column 145): " + [ v.andOr.constructor.name ]);
          })(),
                  ...
                  return function (nl) {
                      return function (self) {
                          var nlMap = function (word) {
                              return function (nldict) {
                                  ...
                                  return Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)(Control_Bind.bind(Control_Bind.bindArray)(langs)(function (lg) {
                                      ...
                                      var longtext = Data_Maybe.fromMaybe("")(Data_Map_Internal.lookup(Data_Ord.ordString)(word)(lgDict));
                          ...
                          if (self instanceof AnyAll_Types.Any) {
                              return ask2view(AnyAll_Types.mkQ(initVis)(AnyAll_Types.Or.value)(Data_Map_Internal.empty)(new Data_Maybe.Just(self.value0))(AnyAll_Types.Default(new Data_Either.Left(selfValue)))(repaintedChildren));
                          };
                          if (self instanceof AnyAll_Types.All) {
                              return ask2view(AnyAll_Types.mkQ(initVis)(AnyAll_Types.And.value)(Data_Map_Internal.empty)(new Data_Maybe.Just(self.value0))(AnyAll_Types.Default(new Data_Either.Left(selfValue)))(repaintedChildren));
                          };
                          throw new Error("Failed pattern match at AnyAll.Relevance (line 33, column 3 - line 44, column 127): " + [ self.constructor.name ]);
                      };
                  };
              };
          };
