...
(function($PS) {
  ...
  var maybe2string = function (dictShow) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at AnyAll.Types (line 182, column 1 - line 182, column 32): " + [ v.constructor.name ]);
      };
  };
  ...
  var genericShouldView = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at AnyAll.Types (line 187, column 1 - line 187, column 58): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var dumpPrePost = function (v) {
      ...
      throw new Error("Failed pattern match at AnyAll.Types (line 177, column 1 - line 177, column 53): " + [ v.constructor.name ]);
  };
  var dumpDefault = function (dictShow) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at AnyAll.Types (line 111, column 1 - line 111, column 62): " + [ v.constructor.name ]);
      };
  }; 
  ...
  var qoutjs = function (v) {
      return QoutJS(Option.fromRecord(Option.fromRecordAny(Option.fromRecordOptionCons(new Data_Symbol.IsSymbol(function () {
          ...
          andOr: (function () {
              ...
              throw new Error("Failed pattern match at AnyAll.Types (line 164, column 45 - line 166, column 124): " + [ v.andOr.constructor.name ]);
          })(),
...
(function($PS) {
  ...
  var getItemByName = function (itemname) {
      ...
      throw new Error("Failed pattern match at Main (line 96, column 3 - line 98, column 24): " + [ v.constructor.name ]);
  };
