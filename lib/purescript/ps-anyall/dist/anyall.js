...
(function($PS) {
  ...
  var maybe2string = function (dictShow) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at AnyAll.Types (line 195, column 1 - line 195, column 32): " + [ v.constructor.name ]);
      };
  };
  ...
  var genericShouldView = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at AnyAll.Types (line 200, column 1 - line 200, column 58): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var dumpPrePost = function (v) {
      ...
      throw new Error("Failed pattern match at AnyAll.Types (line 190, column 1 - line 190, column 53): " + [ v.constructor.name ]);
  };
  var dumpDefault = function (dictShow) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at AnyAll.Types (line 113, column 1 - line 113, column 62): " + [ v.constructor.name ]);
      };
  };
          ...
          andOr: (function () {
              ...
              if (v.andOr instanceof Simply) {
                  return Option.fromRecord(Option.fromRecordAny(Option.fromRecordOptionConsMaybe(new Data_Symbol.IsSymbol(function () {
                      ...
                      nl: Option.fromRecord(Option.fromRecordAny(Option.fromRecordOptionCons(new Data_Symbol.IsSymbol(function () {
                          return "en";
                      }))(Option.fromRecordOptionNil)()()())(Option.fromRecordRequiredNil)()()())({
                          en: Data_Maybe.fromMaybe("")(Data_Map_Internal.lookup(Data_Ord.ordString)(v.andOr.value0)(v.tagNL))
                      })
                  });
              };
              throw new Error("Failed pattern match at AnyAll.Types (line 175, column 20 - line 179, column 133): " + [ v.andOr.constructor.name ]);
          })(),
  ...
  var evaluate = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at AnyAll.Relevance (line 59, column 1 - line 59, column 61): " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
                  ...
                  return function (nl) {
                      return function (self) {
                          var getChildren = function (v) {
                              ...
                              throw new Error("Failed pattern match at AnyAll.Relevance (line 46, column 5 - line 46, column 30): " + [ v.constructor.name ]);
                          };
                          var enMap = function (nldict) {
                              return Data_Maybe.fromMaybe(Data_Map_Internal.empty)(Data_Map_Internal.lookup(Data_Ord.ordString)("en")(nl));
                          };
                          ...
                          if (self instanceof AnyAll_Types.Leaf) {
                              ...
                              if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Either.Right) {
                                  return {
                                      ...
                                      tagNL: Data_Maybe.fromMaybe(Data_Map_Internal.empty)(Data_Map_Internal.lookup(Data_Ord.ordString)(self.value0)(nl)),
                              ...
                              if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Either.Left) {
                                  return AnyAll_Types.mkQ((function () {
                                      ...
                                      return AnyAll_Types.Hide.value;
                                  })())(new AnyAll_Types.Simply(self.value0))(enMap(nl))(Data_Maybe.Nothing.value)(AnyAll_Types.Default(new Data_Either.Left(v.value0.value0)))([  ]);
                              };
                              if (v instanceof Data_Maybe.Nothing) {
                                  return AnyAll_Types.mkQ((function () {
                                      ...
                                      return AnyAll_Types.Hide.value;
                                  })())(new AnyAll_Types.Simply(self.value0))(enMap(nl))(Data_Maybe.Nothing.value)(AnyAll_Types.Default(new Data_Either.Left(Data_Maybe.Nothing.value)))([  ]);
                              };
                              throw new Error("Failed pattern match at AnyAll.Relevance (line 32, column 24 - line 40, column 148): " + [ v.constructor.name ]);
                          };
                          if (self instanceof AnyAll_Types.Any) {
                              return ask2view(AnyAll_Types.mkQ(initVis)(AnyAll_Types.Or.value)(enMap(nl))(new Data_Maybe.Just(self.value0))(AnyAll_Types.Default(new Data_Either.Left(selfValue)))(repaintedChildren));
                          };
                          if (self instanceof AnyAll_Types.All) {
                              return ask2view(AnyAll_Types.mkQ(initVis)(AnyAll_Types.And.value)(enMap(nl))(new Data_Maybe.Just(self.value0))(AnyAll_Types.Default(new Data_Either.Left(selfValue)))(repaintedChildren));
                          };
                          throw new Error("Failed pattern match at AnyAll.Relevance (line 31, column 3 - line 42, column 128): " + [ self.constructor.name ]);
                      };
                  };
              };
          };
...
(function($PS) {
  ...
  var schedule1_part1 = new AnyAll_Types.Any(new AnyAll_Types.Pre("any of the following are prescribed personal data:"), [ new AnyAll_Types.Leaf("1"), new AnyAll_Types.Leaf("2"), new AnyAll_Types.Leaf("3"), new AnyAll_Types.Leaf("4"), new AnyAll_Types.Any(new AnyAll_Types.Pre("5"), [ new AnyAll_Types.Leaf("5.a"), new AnyAll_Types.Leaf("5.b"), new AnyAll_Types.Leaf("5.c"), new AnyAll_Types.Leaf("5.d"), new AnyAll_Types.Leaf("5.e"), new AnyAll_Types.Leaf("5.f"), new AnyAll_Types.Leaf("5.g"), new AnyAll_Types.Leaf("5.h") ]), new AnyAll_Types.Any(new AnyAll_Types.Pre("6"), [ new AnyAll_Types.Leaf("6.a"), new AnyAll_Types.Leaf("6.b"), new AnyAll_Types.Leaf("6.c"), new AnyAll_Types.Leaf("6.d"), new AnyAll_Types.Leaf("6.e") ]), new AnyAll_Types.Any(new AnyAll_Types.Pre("7"), [ new AnyAll_Types.Leaf("7.a"), new AnyAll_Types.Leaf("7.b"), new AnyAll_Types.Leaf("7.c") ]), new AnyAll_Types.Leaf("7"), new AnyAll_Types.Leaf("8"), new AnyAll_Types.Leaf("9"), new AnyAll_Types.Leaf("10"), new AnyAll_Types.Leaf("11"), new AnyAll_Types.Leaf("12"), new AnyAll_Types.Leaf("13"), new AnyAll_Types.Leaf("14"), new AnyAll_Types.Leaf("15"), new AnyAll_Types.Any(new AnyAll_Types.Pre("16"), [ new AnyAll_Types.Leaf("16.a"), new AnyAll_Types.Leaf("16.b") ]), new AnyAll_Types.Any(new AnyAll_Types.Pre("17"), [ new AnyAll_Types.Leaf("17.a"), new AnyAll_Types.Leaf("17.b"), new AnyAll_Types.Leaf("17.c"), new AnyAll_Types.Leaf("17.d"), new AnyAll_Types.Leaf("17.e") ]), new AnyAll_Types.Any(new AnyAll_Types.Pre("18"), [ new AnyAll_Types.Leaf("18.a"), new AnyAll_Types.Leaf("18.b"), new AnyAll_Types.Leaf("18.c"), new AnyAll_Types.Leaf("18.d") ]), new AnyAll_Types.Any(new AnyAll_Types.Pre("19"), [ new AnyAll_Types.Leaf("19.a"), new AnyAll_Types.Leaf("19.b") ]), new AnyAll_Types.Any(new AnyAll_Types.Pre("20"), [ new AnyAll_Types.Leaf("20.a"), new AnyAll_Types.Leaf("20.b"), new AnyAll_Types.Leaf("20.c") ]), new AnyAll_Types.Leaf("20"), new AnyAll_Types.Leaf("21"), new AnyAll_Types.Leaf("22"), new AnyAll_Types.Any(new AnyAll_Types.Pre("23"), [ new AnyAll_Types.Leaf("23.a"), new AnyAll_Types.Leaf("23.b"), new AnyAll_Types.Leaf("23.c"), new AnyAll_Types.Leaf("23.d"), new AnyAll_Types.Leaf("23.e"), new AnyAll_Types.Leaf("23.f") ]) ]);
...
(function($PS) {
  ...
  var getItemByName = function (itemname) {
      ...
      throw new Error("Failed pattern match at Main (line 112, column 3 - line 114, column 24): " + [ v.constructor.name ]);
  };
