...
var paintOut = AA.paint(AA.hard)(simpleMarking)(AA.getNLByName("example1"))(AA.getItemByName("example1"));
...
var paintOut2 = AA.paint(AA.soft)(fancyMarking)(AA.getNLByName("example1"))(example2);
