...
| WHO   | is not                                                                          | processing personal data on behalf of and for the purposes of a public agency |     |     |
...
*** setting   dataBreach { Notifiable = True }
:PROPERTIES:
...
|   |              |         |        |       |                         |                                                  |   |                                                              |                                                    |                                        |                       |   |   |   |   |   | // | LEST | You         | MUST |   |            |                                                                         |
|   |              |         | ➔      |       | NOTIFY                  | the PDPC                                         |   |                                                              |                                                    |                                        |                       |   |   |   |   |   | // |      |             | ➔    |   | notify     | the PDPC                                                                |
|   |              |         |        |       | in                      | the form and manner specified at www.pdpc.gov.sg |   |                                                              |                                                    |                                        |                       |   |   |   |   |   | // |      |             |      |   | in         | the form and manner specified at www.pdpc.gov.sg                        |
|   |              |         |        |       | with                    | a Notification Message                           |   |                                                              |                                                    | // can we link to a constitutive rule? |                       |   |   |   |   |   | // |      |             |      |   | with       | a message containing certain prescribed information                     |
|   |              |         |        |       | and                     | (optional)                                       |   | a list of individuals for whom notification waiver is sought |                                                    |                                        |                       |   |   |   |   |   | // |      |             |      |   | and        | (optional) a list of individuals for whom notification waiver is sought |
|   |              |         |        |       |                         |                                                  |   | together with                                                |                                                    |                                        | justification for why |   |   |   |   |   | // |      |             | AND  |   | provide to | the PDPC                                                                |
|   |              |         |        |       |                         |                                                  |   |                                                              |                                                    |                                        |                       |   |   |   |   |   | // |      | (Regs §5.2) |      |   |            | an explanation for why your notification was late                       |
|   |              |         | HENCE  |       | the PDPC                | MAY                                              |   |                                                              |                                                    |                                        |                       |   |   |   |   |   |    |      |             |      |   |            |                                                                         |
|   |              |         |        |       |                         |                                                  |   | NOTIFY                                                       | you                                                |                                        |                       |   |   |   |   |   |    |      |             |      |   |            |                                                                         |
|   |              |         |        |       |                         |                                                  |   | with                                                         | a list of individuals to exclude from notification |                                        |                       |   |   |   |   |   |    |      |             |      |   |            |                                                                         |
...
| DEEM  | it is                 | unlikely that the notifiable data breach will result in significant harm to the affected individual |    |                                                                                                      |
| AKA   | "Unlikely"            |                                                                                                     |    |                                                                                                      |
...
**** pdpadbno-7: simpler version to test setPlus and setLess
:PROPERTIES:
...
| PARTY | You          |       |                                |
| MUST  | Party Hearty |       |                                |
| WHERE | Party Hearty | MEANS | to party with great enthusiasm |
