...
** About Indentation, Right-Associativity, and Precedence
...
*** multi-line WHO RPParamText
:PROPERTIES:
:TABLE_EXPORT_FILE: who-4.csv
:TABLE_EXPORT_FORMAT: orgtbl-to-csv
:END:

if there are subsequent lines in the ParamText, those lines MUST start directly under the initial first keyword.
